...
@Entity
@Table(name = "k_personal_update_request")
public class PersonalUpdateRequestDO {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "id_update_request")
    ...
    @Column(name = "ds_field_name", nullable = false, length = 100)
    private String dsFieldName;

    @Column(name = "ds_current_value", length = 500)
    private String dsCurrentValue;

    @Column(name = "ds_new_value", nullable = false, length = 500)
    private String dsNewValue;

    @Column(name = "ds_status", nullable = false, length = 50)
    private String dsStatus = "PENDIENTE";

    @Column(name = "ds_approved_by", length = 200)
