...
public interface IInsuranceService {
    ...
    InsuranceDO saveOrUpdateNotification(InsuranceTableTO insuranceTO);
    ...
    List<Map<String,String>> getInsuranseUser(List<Long> idUser);
    Map<String,String> geInsurangeByInsurance(Long idInsurance);
    List<Long> getInsurangeUserAssigment(Long idUser);
