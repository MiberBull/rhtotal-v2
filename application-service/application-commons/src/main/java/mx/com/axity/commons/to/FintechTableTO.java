...
public class FintechTableTO {
    ...
    private String nextIncomePayment;
    private String confirmationFolioSICO;
    private String operationresultSICO;
    private String operationDescriptionSICO;
    ...
    public String getRejectApprove() {
        return rejectApprove;
    }

    public void setRejectApprove(String rejectApprove) {
        this.rejectApprove = rejectApprove;
    }
    ...
    public void setPaymentIncome(String paymentIncome) {
    ...
    public String getNextIncomePayment() {
        return nextIncomePayment;
    }

    public void setNextIncomePayment(String nextIncomePayment) {
        this.nextIncomePayment = nextIncomePayment;
    }
    ...
    public String getOperationDescriptionSICO() {
        return operationDescriptionSICO;
    }

    public void setOperationDescriptionSICO(String operationDescriptionSICO) {
        this.operationDescriptionSICO = operationDescriptionSICO;
    }

    public String getPayrollPayment() {
        return payrollPayment;
    }

    public void setPayrollPayment(String payrollPayment) {
