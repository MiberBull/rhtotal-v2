...
export class LifeInsuranceComponent implements OnInit {
  ...
  @ViewChild('inputFilePdf') inputFilePDF: ElementRef<any>;
  ...
  constructor(private _fb: FormBuilder,
    ...
    this.insuranceFrom = this._fb.group({
      ...
      noCertificate: [DECLARATION.EMPTY_INPUT, [Validators.required, Validators.pattern(EXPRESSION.ALPHANUMERIC_CODE)]],
      ...
      notificationTime: ['', [Validators.required, Validators.pattern(EXPRESSION.ALPHANUMERIC_CODE)]],
  ...
  saveUpdateInsurance(){
    ...
    this.insuranceTableTO.noCertificate = this.insuranceFrom.get('noCertificate').value;    
  ...
  showEditOrSave() {     
    this.showSaveUpdate = this.showSaveUpdate ? false : true;
