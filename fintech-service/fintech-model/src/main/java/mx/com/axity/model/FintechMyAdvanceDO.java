...
@Entity
@Table( name = "k_advance_paysheet",schema = "public")
public class FintechMyAdvanceDO {
    ...
    @Column(name = "qt_loan_commission")
    private BigDecimal loanCommission;

    @Column(name = "qt_deposit_amount")
    private BigDecimal depositAmount;

    @Column(name = "qt_porc_commission")
    private BigDecimal porcCommission;
    ...
    public BigDecimal getPorcCommission() {
        return porcCommission;
    }

    public void setPorcCommission(BigDecimal porcCommission) {
        this.porcCommission = porcCommission;
    }
}
